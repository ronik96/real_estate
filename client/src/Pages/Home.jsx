    ...
    <div>
      ...
      <div className=' container py-24 mx-auto  px-4'>
        ...
        <div className=' grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
          ...
          <div className=' pe-5 pb-2 flex flex-col items-end lg:border-e-2 border-gray-400 border-e-2 '>
            <div>
              <div>
          ...
          <div className=' pe-5 pb-2 flex flex-col items-end w-full md:border-e-2 border-gray-400'>
            <div>
              <div>
